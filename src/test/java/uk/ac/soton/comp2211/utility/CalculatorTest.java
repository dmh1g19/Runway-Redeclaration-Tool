...
class CalculatorTest {
    ...
    static void initialiseAirport() {
        ...
        runways[0] = new Runway("09R", 4022, 280, 90, 3660, 3660, 3660, 3353, 0);
        runways[0].setDisplacedThreshold(307);
        runways[1] = new Runway("27L", 4022, 280, 270, 3660, 3660, 3660, 3660, 0);
        runways[2] = new Runway("09L", 4022, 280, 90, 3902, 3902, 3902, 3595, 0);
        runways[2].setDisplacedThreshold(306);
        runways[3] = new Runway("27R", 4022, 280, 270, 3884, 3962, 3884, 3884, 78);
